...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($errors)) {
            ...
            $query = "INSERT INTO Customer (CustomerID, CustomerFirstName, CustomerLastName, CustomerNationalID, CustomerPhone, CustomerAddress, CustomerEmail, CustomerPassword,CustomerRole)
                      VALUES ('$CustomerID', '$firstName', '$lastName', '$nationalID', '$phone', '$address', '$email', '$hashedPassword', 'user')";

            if (mysqli_query($connection, $query)) {
                echo "<script type='text/javascript'>
                        alert('Customer Registered Successfully. Please Log in to your account');
    ...
    <div class="registration-form">
        ...
        <form action="userregister.php" method="post" onsubmit="return validatePassword()">
