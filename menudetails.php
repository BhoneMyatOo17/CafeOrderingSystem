...
if(isset($_GET['ProductID'])) {
    ...
    $Product_Amount = $row['ProductPrice'];
...
<head>
    ...
    <title><?php echo $Product_Name; ?> - The Urban Brew</title>
                        ...
                        <div class="product-card">
                            <div class="row no-gutters">
                                <div class="col-md-6 product-image-container">
                                    <img src="<?php echo $Product_Image_1; ?>" alt="<?php echo $Product_Name; ?>" class="img-fluid">
                                </div>
                                <div class="col-md-6 product-info-container">
                                    <div class="move">
                                    <h1 class="product-title"><?php echo $Product_Name; ?></h1>
                                    <div class="product-price">$<?php echo $Product_Amount; ?></div>
                                    <p class="product-description"><?php echo $Product_Description; ?></p>
                                    
                                    <form action="menudetails.php" method="GET" class="product-form">
                                        <input type="hidden" name="Action" value="Buy">
                                        <input type="hidden" name="txtProductID" value="<?php echo $Product_ID; ?>">
                                        
                                        <div class="quantity-control">
                                            <span class="quantity-label">Quantity:</span>
                                            <input type="number" name="txtBuyQty" class="quantity-input" 
                                                   min="1" max="10" value="1">
                                        </div>
                                        
                                        <button type="submit" name="Buy" class="btn btn-primary btn-shadow btn-lg btn-add-to-cart">
                                            Add to Cart
                                        </button>
                                    </form>
                                    </div>
